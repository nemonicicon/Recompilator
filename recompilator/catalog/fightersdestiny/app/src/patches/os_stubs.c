 ...
 *
 * SESSION 44: identified in FIGHTERSDESTINY by signature (tools/match_libultra.py); these
 * four are the ones FIGHTERSDESTINY's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), fightersdestinypc has no game patches — the game's own recompiled
