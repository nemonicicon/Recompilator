 ...
 *
 * SESSION 44: identified in SUPERMAN by signature (tools/match_libultra.py); these
 * four are the ones SUPERMAN's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), supermanpc has no game patches — the game's own recompiled
