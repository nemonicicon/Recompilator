 ...
 *
 * SESSION 44: identified in JEREMYMCGRATHSUPER by signature (tools/match_libultra.py); these
 * four are the ones JEREMYMCGRATHSUPER's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), jeremymcgrathsuperpc has no game patches — the game's own recompiled
