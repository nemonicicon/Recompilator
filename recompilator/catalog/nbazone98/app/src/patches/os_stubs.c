 ...
 *
 * SESSION 44: identified in NBAZONE98 by signature (tools/match_libultra.py); these
 * four are the ones NBAZONE98's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nbazone98pc has no game patches — the game's own recompiled
