 ...
 *
 * SESSION 44: identified in THPS by signature (tools/match_libultra.py); these
 * four are the ones THPS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), thpspc has no game patches — the game's own recompiled
