 ...
 *
 * SESSION 44: identified in LEGENDOFZELDATHEMA by signature (tools/match_libultra.py); these
 * four are the ones LEGENDOFZELDATHEMA's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), legendofzeldathemapc has no game patches — the game's own recompiled
