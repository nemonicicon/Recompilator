/**
 * rt64_renderer.cpp — RT64Context implementation for G1080SNOWBOARDINGPC.
 *
 * Same wrapper as cv64pc's (the engine-proven shape), minus the CV64-specific
 * DL-dump probes. G1080SNOWBOARDING uses the same F3DEX2 fifo 2.06 microcode as CV64.
 */
                         ...
                         bool developer_mode)
{
    ...
    appConfig.appId = "g1080snowboardingpc";
