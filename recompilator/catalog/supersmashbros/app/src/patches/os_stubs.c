 ...
 *
 * SESSION 44: identified in SUPERSMASHBROS by signature (tools/match_libultra.py); these
 * four are the ones SUPERSMASHBROS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), supersmashbrospc has no game patches — the game's own recompiled
