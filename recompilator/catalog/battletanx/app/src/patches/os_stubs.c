 ...
 *
 * SESSION 44: identified in BATTLETANX by signature (tools/match_libultra.py); these
 * four are the ones BATTLETANX's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), battletanxpc has no game patches — the game's own recompiled
