 ...
 *
 * SESSION 44: identified in ELMOLETTER by signature (tools/match_libultra.py); these
 * four are the ones ELMOLETTER's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), elmoletterpc has no game patches — the game's own recompiled
