 ...
 *
 * SESSION 44: identified in CHARLIE by signature (tools/match_libultra.py); these
 * four are the ones CHARLIE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), charliepc has no game patches — the game's own recompiled
