 ...
 *
 * SESSION 44: identified in SOUTHPARK by signature (tools/match_libultra.py); these
 * four are the ones SOUTHPARK's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), southparkpc has no game patches — the game's own recompiled
