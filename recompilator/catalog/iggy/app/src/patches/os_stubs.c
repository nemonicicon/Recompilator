 ...
 *
 * SESSION 44: identified in IGGY by signature (tools/match_libultra.py); these
 * four are the ones IGGY's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), iggypc has no game patches — the game's own recompiled
