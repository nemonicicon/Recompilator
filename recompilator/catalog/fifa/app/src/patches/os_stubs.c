 ...
 *
 * SESSION 44: identified in FIFA by signature (tools/match_libultra.py); these
 * four are the ones FIFA's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), fifapc has no game patches — the game's own recompiled
