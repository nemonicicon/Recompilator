 ...
 *
 * SESSION 44: identified in BEETLE by signature (tools/match_libultra.py); these
 * four are the ones BEETLE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), beetlepc has no game patches — the game's own recompiled
