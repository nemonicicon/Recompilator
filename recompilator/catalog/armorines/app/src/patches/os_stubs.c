 ...
 *
 * SESSION 44: identified in ARMORINES by signature (tools/match_libultra.py); these
 * four are the ones ARMORINES's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), armorinespc has no game patches — the game's own recompiled
