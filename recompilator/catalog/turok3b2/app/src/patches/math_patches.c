 ...
 *
 * TUROK3B2's recompiled code calls __d_to_ull (the link-time scorecard found it;
 * TUROK3B2 never references __f_to_ull). Register convention VERIFIED against the
 * TUROK3B2 caller (funcs_27.c func_8029D4D0: `sw $v0,0x18($sp); sw $v1,0x1C($sp)`
 ...
 * corrected here (it is unreferenced in TUROK3B2, kept for parity).
 */
