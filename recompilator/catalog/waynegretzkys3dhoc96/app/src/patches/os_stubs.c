 ...
 *
 * SESSION 44: identified in WAYNEGRETZKYS3DHOC by signature (tools/match_libultra.py); these
 * four are the ones WAYNEGRETZKYS3DHOC's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), waynegretzkys3dhoc96pc has no game patches — the game's own recompiled
