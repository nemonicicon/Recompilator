 ...
 *
 * SESSION 44: identified in MAJORLEAGUEBASEBAL by signature (tools/match_libultra.py); these
 * four are the ones MAJORLEAGUEBASEBAL's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), majorleaguebasebalpc has no game patches — the game's own recompiled
