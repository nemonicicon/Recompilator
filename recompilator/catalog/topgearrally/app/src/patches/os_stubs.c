 ...
 *
 * SESSION 44: identified in TOPGEARRALLY by signature (tools/match_libultra.py); these
 * four are the ones TOPGEARRALLY's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), topgearrallypc has no game patches — the game's own recompiled
