 ...
 *
 * SESSION 44: identified in JEOPARDY by signature (tools/match_libultra.py); these
 * four are the ones JEOPARDY's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), jeopardypc has no game patches — the game's own recompiled
