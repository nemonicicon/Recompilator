 ...
 *
 * SESSION 44: identified in ISS98 by signature (tools/match_libultra.py); these
 * four are the ones ISS98's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), iss98pc has no game patches — the game's own recompiled
