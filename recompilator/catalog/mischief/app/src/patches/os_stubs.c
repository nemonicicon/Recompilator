 ...
 *
 * SESSION 44: identified in MISCHIEF by signature (tools/match_libultra.py); these
 * four are the ones MISCHIEF's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mischiefpc has no game patches — the game's own recompiled
