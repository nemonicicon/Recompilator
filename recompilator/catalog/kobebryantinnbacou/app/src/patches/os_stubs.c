 ...
 *
 * SESSION 44: identified in KOBEBRYANTINNBACOU by signature (tools/match_libultra.py); these
 * four are the ones KOBEBRYANTINNBACOU's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), kobebryantinnbacoupc has no game patches — the game's own recompiled
