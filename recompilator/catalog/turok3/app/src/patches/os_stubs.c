 ...
 *
 * SESSION 44: identified in TUROK3 by signature (tools/match_libultra.py); these
 * four are the ones TUROK3's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), turok3pc has no game patches — the game's own recompiled
