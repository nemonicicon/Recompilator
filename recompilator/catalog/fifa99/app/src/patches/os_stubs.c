 ...
 *
 * SESSION 44: identified in FIFA99 by signature (tools/match_libultra.py); these
 * four are the ones FIFA99's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), fifa99pc has no game patches — the game's own recompiled
