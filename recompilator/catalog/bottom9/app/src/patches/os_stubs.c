 ...
 *
 * SESSION 44: identified in BOTTOM9 by signature (tools/match_libultra.py); these
 * four are the ones BOTTOM9's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), bottom9pc has no game patches — the game's own recompiled
