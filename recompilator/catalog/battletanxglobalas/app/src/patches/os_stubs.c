 ...
 *
 * SESSION 44: identified in BATTLETANXGLOBALAS by signature (tools/match_libultra.py); these
 * four are the ones BATTLETANXGLOBALAS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), battletanxglobalaspc has no game patches — the game's own recompiled
