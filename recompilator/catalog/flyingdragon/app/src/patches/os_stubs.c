 ...
 *
 * SESSION 44: identified in FLYINGDRAGON by signature (tools/match_libultra.py); these
 * four are the ones FLYINGDRAGON's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), flyingdragonpc has no game patches — the game's own recompiled
