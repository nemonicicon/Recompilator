 ...
 *
 * SESSION 44: identified in ALLSTARBASEBALL2001 by signature (tools/match_libultra.py); these
 * four are the ones ALLSTARBASEBALL2001's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), allstarbaseball2001pc has no game patches — the game's own recompiled
