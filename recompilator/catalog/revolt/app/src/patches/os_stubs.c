 ...
 *
 * SESSION 44: identified in REVOLT by signature (tools/match_libultra.py); these
 * four are the ones REVOLT's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), revoltpc has no game patches — the game's own recompiled
