 ...
 *
 * SESSION 44: identified in VIGILANTE8 by signature (tools/match_libultra.py); these
 * four are the ones VIGILANTE8's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), vigilante8pc has no game patches — the game's own recompiled
