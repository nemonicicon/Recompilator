 ...
 *
 * SESSION 44: identified in ALLSTARBASEBALL99 by signature (tools/match_libultra.py); these
 * four are the ones ALLSTARBASEBALL99's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), allstarbaseball99pc has no game patches — the game's own recompiled
