 ...
 *
 * SESSION 44: identified in LODERUNNER3D by signature (tools/match_libultra.py); these
 * four are the ones LODERUNNER3D's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), loderunner3dpc has no game patches — the game's own recompiled
