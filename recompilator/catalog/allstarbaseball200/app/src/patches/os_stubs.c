 ...
 *
 * SESSION 44: identified in ALLSTARBASEBALL200 by signature (tools/match_libultra.py); these
 * four are the ones ALLSTARBASEBALL200's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), allstarbaseball200pc has no game patches — the game's own recompiled
