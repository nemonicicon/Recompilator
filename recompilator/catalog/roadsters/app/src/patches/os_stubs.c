 ...
 *
 * SESSION 44: identified in ROADSTERS by signature (tools/match_libultra.py); these
 * four are the ones ROADSTERS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), roadsterspc has no game patches — the game's own recompiled
