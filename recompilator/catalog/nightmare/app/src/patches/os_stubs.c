 ...
 *
 * SESSION 44: identified in NIGHTMARE by signature (tools/match_libultra.py); these
 * four are the ones NIGHTMARE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nightmarepc has no game patches — the game's own recompiled
