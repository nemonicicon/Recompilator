 ...
 *
 * SESSION 44: identified in PGAEUROPEANTOUR by signature (tools/match_libultra.py); these
 * four are the ones PGAEUROPEANTOUR's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), pgaeuropeantourpc has no game patches — the game's own recompiled
