 ...
 *
 * SESSION 44: identified in MADDENNFL2002 by signature (tools/match_libultra.py); these
 * four are the ones MADDENNFL2002's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), maddennfl2002pc has no game patches — the game's own recompiled
