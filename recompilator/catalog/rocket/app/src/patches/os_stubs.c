 ...
 *
 * SESSION 44: identified in ROCKET by signature (tools/match_libultra.py); these
 * four are the ones ROCKET's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), rocketpc has no game patches — the game's own recompiled
