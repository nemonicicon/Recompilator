 ...
 *
 * SESSION 44: identified in CF63 by signature (tools/match_libultra.py); these
 * four are the ones CF63's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), cf63pc has no game patches — the game's own recompiled
