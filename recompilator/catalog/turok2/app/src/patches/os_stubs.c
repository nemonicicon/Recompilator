 ...
 *
 * SESSION 44: identified in TUROK2 by signature (tools/match_libultra.py); these
 * four are the ones TUROK2's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), turok2pc has no game patches — the game's own recompiled
