/**
 * rt64_renderer.cpp — RT64Context implementation for WAYNEGRETZKYS3DHOCPC.
 *
 * Same wrapper as cv64pc's (the engine-proven shape), minus the CV64-specific
 * DL-dump probes. WAYNEGRETZKYS3DHOC uses the same F3DEX2 fifo 2.06 microcode as CV64.
 */
...
namespace waynegretzkys3dhoc96 {
namespace renderer {
                         ...
                         bool developer_mode)
{
    ...
    appConfig.appId = "waynegretzkys3dhoc96pc";
