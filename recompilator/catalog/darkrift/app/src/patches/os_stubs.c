 ...
 *
 * SESSION 44: identified in DARKRIFT by signature (tools/match_libultra.py); these
 * four are the ones DARKRIFT's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), darkriftpc has no game patches — the game's own recompiled
