 ...
 *
 * SESSION 44: identified in NHLBREAK98 by signature (tools/match_libultra.py); these
 * four are the ones NHLBREAK98's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nhlbreak98pc has no game patches — the game's own recompiled
