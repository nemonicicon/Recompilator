 ...
 *
 * SESSION 44: identified in NFLQBCLUB2001 by signature (tools/match_libultra.py); these
 * four are the ones NFLQBCLUB2001's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nflqbclub2001pc has no game patches — the game's own recompiled
