 ...
 *
 * SESSION 44: identified in FIFA98RD by signature (tools/match_libultra.py); these
 * four are the ones FIFA98RD's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), fifa98rdpc has no game patches — the game's own recompiled
