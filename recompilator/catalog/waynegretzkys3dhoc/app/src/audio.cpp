...
void waynegretzkys3dhoc_queue_samples(int16_t* audio_data, size_t sample_count) {
...
size_t waynegretzkys3dhoc_get_frames_remaining() {
...
void waynegretzkys3dhoc_set_frequency(uint32_t freq) {
    fprintf(stderr, "[audio_freq] waynegretzkys3dhoc_set_frequency(%u) (was %u)\n", freq, current_freq);
    fflush(stderr);
...
void waynegretzkys3dhoc_audio_init() {
    waynegretzkys3dhoc_set_frequency(current_freq);
}

// Public callback struct to pass to recomp::start().
ultramodern::audio_callbacks_t get_audio_callbacks() {
    return {
        .queue_samples      = waynegretzkys3dhoc_queue_samples,
        .get_frames_remaining = waynegretzkys3dhoc_get_frames_remaining,
        .set_frequency      = waynegretzkys3dhoc_set_frequency,
    };
}
