 ...
 *
 * SESSION 44: identified in DUKENUKEM64 by signature (tools/match_libultra.py); these
 * four are the ones DUKENUKEM64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), dukenukem64pc has no game patches — the game's own recompiled
