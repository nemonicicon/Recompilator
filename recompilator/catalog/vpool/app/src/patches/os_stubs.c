 ...
 *
 * SESSION 44: identified in VPOOL by signature (tools/match_libultra.py); these
 * four are the ones VPOOL's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), vpoolpc has no game patches — the game's own recompiled
