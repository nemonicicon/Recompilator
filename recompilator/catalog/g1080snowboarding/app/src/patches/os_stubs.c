 ...
 *
 * SESSION 44: identified in G1080SNOWBOARDING by signature (tools/match_libultra.py); these
 * four are the ones G1080SNOWBOARDING's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), g1080snowboardingpc has no game patches — the game's own recompiled
