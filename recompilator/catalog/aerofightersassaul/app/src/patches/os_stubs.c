 ...
 *
 * SESSION 44: identified in AEROFIGHTERSASSAUL by signature (tools/match_libultra.py); these
 * four are the ones AEROFIGHTERSASSAUL's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), aerofightersassaulpc has no game patches — the game's own recompiled
