 ...
 *
 * SESSION 44: identified in ROBOTRON by signature (tools/match_libultra.py); these
 * four are the ones ROBOTRON's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), robotronpc has no game patches — the game's own recompiled
