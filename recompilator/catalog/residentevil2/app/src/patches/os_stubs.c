 ...
 *
 * SESSION 44: identified in RESIDENTEVIL2 by signature (tools/match_libultra.py); these
 * four are the ones RESIDENTEVIL2's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), residentevil2pc has no game patches — the game's own recompiled
