 ...
 *
 * SESSION 44: identified in SPIDERMAN by signature (tools/match_libultra.py); these
 * four are the ones SPIDERMAN's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), spidermanpc has no game patches — the game's own recompiled
