 ...
 *
 * SESSION 44: identified in TUROK by signature (tools/match_libultra.py); these
 * four are the ones TUROK's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), turokpc has no game patches — the game's own recompiled
