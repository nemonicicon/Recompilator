 ...
 *
 * SESSION 44: identified in NFLBLITZ2001 by signature (tools/match_libultra.py); these
 * four are the ones NFLBLITZ2001's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nflblitz2001pc has no game patches — the game's own recompiled
