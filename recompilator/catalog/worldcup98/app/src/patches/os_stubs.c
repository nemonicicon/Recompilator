 ...
 *
 * SESSION 44: identified in WORLDCUP98 by signature (tools/match_libultra.py); these
 * four are the ones WORLDCUP98's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), worldcup98pc has no game patches — the game's own recompiled
