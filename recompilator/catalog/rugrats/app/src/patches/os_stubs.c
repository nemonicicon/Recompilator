 ...
 *
 * SESSION 44: identified in RUGRATS by signature (tools/match_libultra.py); these
 * four are the ones RUGRATS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), rugratspc has no game patches — the game's own recompiled
