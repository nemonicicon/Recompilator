 ...
 *
 * SESSION 44: identified in MI by signature (tools/match_libultra.py); these
 * four are the ones MI's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mipc has no game patches — the game's own recompiled
