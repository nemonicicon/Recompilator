 ...
 *
 * SESSION 44: identified in GEX64 by signature (tools/match_libultra.py); these
 * four are the ones GEX64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), gex64pc has no game patches — the game's own recompiled
