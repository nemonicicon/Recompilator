 ...
 *
 * SESSION 44: identified in READY2RUMBLEBOXING1 by signature (tools/match_libultra.py); these
 * four are the ones READY2RUMBLEBOXING1's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), ready2rumbleboxing1pc has no game patches — the game's own recompiled
