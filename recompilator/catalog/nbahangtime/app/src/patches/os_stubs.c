 ...
 *
 * SESSION 44: identified in NBAHANGTIME by signature (tools/match_libultra.py); these
 * four are the ones NBAHANGTIME's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nbahangtimepc has no game patches — the game's own recompiled
