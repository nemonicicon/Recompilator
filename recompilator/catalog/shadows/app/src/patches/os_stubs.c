 ...
 *
 * SESSION 44: identified in SHADOWS by signature (tools/match_libultra.py); these
 * four are the ones SHADOWS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), shadowspc has no game patches — the game's own recompiled
