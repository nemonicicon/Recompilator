 ...
 *
 * SESSION 44: identified in DIDDYKONGRACING by signature (tools/match_libultra.py); these
 * four are the ones DIDDYKONGRACING's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), diddykongracingpc has no game patches — the game's own recompiled
