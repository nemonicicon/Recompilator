 ...
 *
 * SESSION 44: identified in WAVERACE64KAWASAKI by signature (tools/match_libultra.py); these
 * four are the ones WAVERACE64KAWASAKI's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), waverace64kawasakipc has no game patches — the game's own recompiled
