 ...
 *
 * SESSION 44: identified in GT64 by signature (tools/match_libultra.py); these
 * four are the ones GT64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), gt64pc has no game patches — the game's own recompiled
