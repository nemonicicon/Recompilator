 ...
 *
 * SESSION 44: identified in NHLBREAK99 by signature (tools/match_libultra.py); these
 * four are the ones NHLBREAK99's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nhlbreak99pc has no game patches — the game's own recompiled
