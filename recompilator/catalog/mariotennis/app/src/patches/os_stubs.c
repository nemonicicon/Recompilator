 ...
 *
 * SESSION 44: identified in MARIOTENNIS by signature (tools/match_libultra.py); these
 * four are the ones MARIOTENNIS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mariotennispc has no game patches — the game's own recompiled
