 ...
 *
 * SESSION 44: identified in MK64 by signature (tools/match_libultra.py); these
 * four are the ones MK64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mk64pc has no game patches — the game's own recompiled
