 ...
 *
 * SESSION 44: identified in SNOWKIDS by signature (tools/match_libultra.py); these
 * four are the ones SNOWKIDS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), snowkidspc has no game patches — the game's own recompiled
