 ...
 *
 * SESSION 44: identified in RAGEWARSR1 by signature (tools/match_libultra.py); these
 * four are the ones RAGEWARSR1's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), ragewarsr1pc has no game patches — the game's own recompiled
