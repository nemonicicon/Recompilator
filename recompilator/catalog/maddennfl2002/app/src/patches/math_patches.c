 ...
 *
 * MADDENNFL2002's recompiled code calls __d_to_ull (the link-time scorecard found it;
 * MADDENNFL2002 never references __f_to_ull). Register convention VERIFIED against the
 * MADDENNFL2002 caller (funcs_27.c func_8029D4D0: `sw $v0,0x18($sp); sw $v1,0x1C($sp)`
 ...
 * corrected here (it is unreferenced in MADDENNFL2002, kept for parity).
 */
