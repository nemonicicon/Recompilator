 ...
 *
 * SESSION 44: identified in AEROGAUGE by signature (tools/match_libultra.py); these
 * four are the ones AEROGAUGE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), aerogaugepc has no game patches — the game's own recompiled
