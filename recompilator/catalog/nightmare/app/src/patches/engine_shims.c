...
/* A build without the GPU renderer (RDPC_CONSOLE_ONLY) has no RDP cost estimator, which the
 * renderer normally defines and the runtime's timing layer reads; 0.0 means "no estimate". */
