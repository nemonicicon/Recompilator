 ...
 *
 * SESSION 44: identified in ROADRASH64 by signature (tools/match_libultra.py); these
 * four are the ones ROADRASH64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), roadrash64pc has no game patches — the game's own recompiled
