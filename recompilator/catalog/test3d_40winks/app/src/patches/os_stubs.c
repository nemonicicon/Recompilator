 ...
 *
 * SESSION 44: identified in TEST3D_40WINKS by signature (tools/match_libultra.py); these
 * four are the ones TEST3D_40WINKS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), test3d_40winkspc has no game patches — the game's own recompiled
