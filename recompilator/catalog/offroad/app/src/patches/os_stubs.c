 ...
 *
 * SESSION 44: identified in OFFROAD by signature (tools/match_libultra.py); these
 * four are the ones OFFROAD's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), offroadpc has no game patches — the game's own recompiled
