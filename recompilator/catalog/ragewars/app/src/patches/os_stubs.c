 ...
 *
 * SESSION 44: identified in RAGEWARS by signature (tools/match_libultra.py); these
 * four are the ones RAGEWARS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), ragewarspc has no game patches — the game's own recompiled
