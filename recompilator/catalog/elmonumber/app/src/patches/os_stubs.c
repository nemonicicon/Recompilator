 ...
 *
 * SESSION 44: identified in ELMONUMBER by signature (tools/match_libultra.py); these
 * four are the ones ELMONUMBER's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), elmonumberpc has no game patches — the game's own recompiled
