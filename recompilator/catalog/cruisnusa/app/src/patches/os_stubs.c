 ...
 *
 * SESSION 44: identified in CRUISNUSA by signature (tools/match_libultra.py); these
 * four are the ones CRUISNUSA's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), cruisnusapc has no game patches — the game's own recompiled
