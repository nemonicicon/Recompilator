 ...
 *
 * SESSION 44: identified in PIAZZA by signature (tools/match_libultra.py); these
 * four are the ones PIAZZA's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), piazzapc has no game patches — the game's own recompiled
