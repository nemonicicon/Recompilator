 ...
 *
 * SESSION 44: identified in CRUISNWORLD by signature (tools/match_libultra.py); these
 * four are the ones CRUISNWORLD's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), cruisnworldpc has no game patches — the game's own recompiled
