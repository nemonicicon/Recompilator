 ...
 *
 * SESSION 44: identified in ROGUE by signature (tools/match_libultra.py); these
 * four are the ones ROGUE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), roguepc has no game patches — the game's own recompiled
