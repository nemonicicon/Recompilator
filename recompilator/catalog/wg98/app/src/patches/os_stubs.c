 ...
 *
 * SESSION 44: identified in WG98 by signature (tools/match_libultra.py); these
 * four are the ones WG98's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), wg98pc has no game patches — the game's own recompiled
