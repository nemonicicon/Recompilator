 ...
 *
 * SESSION 44: identified in HEXEN by signature (tools/match_libultra.py); these
 * four are the ones HEXEN's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), hexenpc has no game patches — the game's own recompiled
