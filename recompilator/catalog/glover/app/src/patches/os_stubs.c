 ...
 *
 * SESSION 44: identified in GLOVER by signature (tools/match_libultra.py); these
 * four are the ones GLOVER's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), gloverpc has no game patches — the game's own recompiled
