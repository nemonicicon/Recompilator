 ...
 *
 * SESSION 44: identified in DOOM64 by signature (tools/match_libultra.py); these
 * four are the ones DOOM64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), doom64pc has no game patches — the game's own recompiled
