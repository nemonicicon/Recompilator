 ...
 *
 * SESSION 44: identified in NIGHTCREAT by signature (tools/match_libultra.py); these
 * four are the ones NIGHTCREAT's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nightcreatpc has no game patches — the game's own recompiled
