 ...
 *
 * SESSION 44: identified in DRAGONKING by signature (tools/match_libultra.py); these
 * four are the ones DRAGONKING's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), dragonkingpc has no game patches — the game's own recompiled
