 ...
 *
 * SESSION 44: identified in SFRUSH by signature (tools/match_libultra.py); these
 * four are the ones SFRUSH's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), sfrushpc has no game patches — the game's own recompiled
