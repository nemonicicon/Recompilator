 ...
 *
 * SESSION 44: identified in TUROK3B1 by signature (tools/match_libultra.py); these
 * four are the ones TUROK3B1's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), turok3b1pc has no game patches — the game's own recompiled
