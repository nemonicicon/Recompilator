/**
 * input.cpp â€” SDL2 gamepad / keyboard input backend for G1080SNOWBOARDINGPC.
 *
...
void g1080snowboarding_poll_input() {
    SDL_Event e;
    while (SDL_PollEvent(&e)) {
        ...
        case SDL_CONTROLLERDEVICEREMOVED:
            ...
            break;
        case SDL_QUIT:
            fprintf(stderr, "[quitwatch] SDL_QUIT received in g1080snowboarding_poll_input\n"); fflush(stderr);
            ultramodern::quit();
            break;
        default:
            break;
...
bool g1080snowboarding_get_input(int controller_num, uint16_t* buttons, float* x, float* y) {
...
void g1080snowboarding_set_rumble(int controller_num, bool rumble) {
...
ultramodern::input::connected_device_info_t g1080snowboarding_get_connected_device(int controller_num) {
    if (controller_num != 0) {
        return { ultramodern::input::Device::None, ultramodern::input::Pak::None };
    }
    // Always report port 0 as having a controller.  g1080snowboarding_get_input() already supplies
...
void g1080snowboarding_input_init() {
...
ultramodern::input::callbacks_t get_input_callbacks() {
    return {
        .poll_input              = g1080snowboarding_poll_input,
        .get_input               = g1080snowboarding_get_input,
        .set_rumble              = g1080snowboarding_set_rumble,
        .get_connected_device_info = g1080snowboarding_get_connected_device,
    };
}
