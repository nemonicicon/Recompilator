 ...
 *
 * SESSION 44: identified in MILO by signature (tools/match_libultra.py); these
 * four are the ones MILO's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), milopc has no game patches — the game's own recompiled
