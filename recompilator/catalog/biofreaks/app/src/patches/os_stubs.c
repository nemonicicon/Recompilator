 ...
 *
 * SESSION 44: identified in BIOFREAKS by signature (tools/match_libultra.py); these
 * four are the ones BIOFREAKS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), biofreakspc has no game patches — the game's own recompiled
