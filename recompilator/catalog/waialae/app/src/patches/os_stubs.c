 ...
 *
 * SESSION 44: identified in WAIALAE by signature (tools/match_libultra.py); these
 * four are the ones WAIALAE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), waialaepc has no game patches — the game's own recompiled
