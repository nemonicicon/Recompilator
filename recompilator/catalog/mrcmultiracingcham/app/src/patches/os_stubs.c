 ...
 *
 * SESSION 44: identified in MRCMULTIRACINGCHAM by signature (tools/match_libultra.py); these
 * four are the ones MRCMULTIRACINGCHAM's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mrcmultiracingchampc has no game patches — the game's own recompiled
