 ...
 *
 * SESSION 44: identified in ECWHCR by signature (tools/match_libultra.py); these
 * four are the ones ECWHCR's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), ecwhcrpc has no game patches — the game's own recompiled
