 ...
 *
 * SESSION 44: identified in NABOO by signature (tools/match_libultra.py); these
 * four are the ones NABOO's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), naboopc has no game patches — the game's own recompiled
