 ...
 *
 * SESSION 44: identified in OLYMPIC98 by signature (tools/match_libultra.py); these
 * four are the ones OLYMPIC98's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), olympic98pc has no game patches — the game's own recompiled
