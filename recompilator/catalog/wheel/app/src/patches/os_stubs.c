 ...
 *
 * SESSION 44: identified in WHEEL by signature (tools/match_libultra.py); these
 * four are the ones WHEEL's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), wheelpc has no game patches — the game's own recompiled
