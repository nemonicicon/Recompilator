 ...
 *
 * SESSION 44: identified in MK4 by signature (tools/match_libultra.py); these
 * four are the ones MK4's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mk4pc has no game patches — the game's own recompiled
