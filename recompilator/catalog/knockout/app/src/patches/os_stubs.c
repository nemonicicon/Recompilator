 ...
 *
 * SESSION 44: identified in KNOCKOUT by signature (tools/match_libultra.py); these
 * four are the ones KNOCKOUT's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), knockoutpc has no game patches — the game's own recompiled
