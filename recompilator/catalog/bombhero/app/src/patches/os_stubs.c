 ...
 *
 * SESSION 44: identified in BOMBHERO by signature (tools/match_libultra.py); these
 * four are the ones BOMBHERO's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), bombheropc has no game patches — the game's own recompiled
