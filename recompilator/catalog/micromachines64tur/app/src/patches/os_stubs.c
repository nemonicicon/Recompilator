 ...
 *
 * SESSION 44: identified in MICROMACHINES64TUR by signature (tools/match_libultra.py); these
 * four are the ones MICROMACHINES64TUR's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), micromachines64turpc has no game patches — the game's own recompiled
