 ...
 *
 * SESSION 44: identified in EXTREMEGXG2 by signature (tools/match_libultra.py); these
 * four are the ones EXTREMEGXG2's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), extremegxg2pc has no game patches — the game's own recompiled
