 ...
 *
 * SESSION 44: identified in CHOPPER by signature (tools/match_libultra.py); these
 * four are the ones CHOPPER's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), chopperpc has no game patches — the game's own recompiled
