 ...
 *
 * SESSION 44: identified in BANJOKAZOOIE by signature (tools/match_libultra.py); these
 * four are the ones BANJOKAZOOIE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), banjokazooiepc has no game patches — the game's own recompiled
