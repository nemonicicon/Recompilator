 ...
 *
 * SESSION 44: identified in MSPACMANMAZEMADNES by signature (tools/match_libultra.py); these
 * four are the ones MSPACMANMAZEMADNES's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mspacmanmazemadnespc has no game patches — the game's own recompiled
