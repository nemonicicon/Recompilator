 ...
 *
 * SESSION 44: identified in MKMYTH by signature (tools/match_libultra.py); these
 * four are the ones MKMYTH's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mkmythpc has no game patches — the game's own recompiled
