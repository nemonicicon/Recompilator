...
// SHA1: d8b1088520f7c5f81433292a9258c1184afa1457 · internal name "Star Fox 64"
static constexpr uint64_t STARFOX64_ROM_HASH        = 0x1050DBD1C8ABEA11ULL;
...
static void prompt_for_rom(const char* rom_hint) {
    ...
    std::u8string out_id = u8"starfox64_us";
...
static int starfox64_app_main(int argc, char** argv)
{
    ...
    std::u8string game_id = u8"starfox64_us";
