 ...
 *
 * SESSION 44: identified in YOSHISTORY by signature (tools/match_libultra.py); these
 * four are the ones YOSHISTORY's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), yoshistorypc has no game patches — the game's own recompiled
