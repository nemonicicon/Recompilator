 ...
 *
 * SESSION 44: identified in TUROK2R1 by signature (tools/match_libultra.py); these
 * four are the ones TUROK2R1's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), turok2r1pc has no game patches — the game's own recompiled
