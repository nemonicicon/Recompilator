 ...
 *
 * SESSION 44: identified in NFLQUARTERBACKCLUB by signature (tools/match_libultra.py); these
 * four are the ones NFLQUARTERBACKCLUB's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nflquarterbackclubpc has no game patches — the game's own recompiled
