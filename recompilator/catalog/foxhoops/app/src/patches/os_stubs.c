 ...
 *
 * SESSION 44: identified in FOXHOOPS by signature (tools/match_libultra.py); these
 * four are the ones FOXHOOPS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), foxhoopspc has no game patches — the game's own recompiled
