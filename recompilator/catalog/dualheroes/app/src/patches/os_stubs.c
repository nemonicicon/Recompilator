 ...
 *
 * SESSION 44: identified in DUALHEROES by signature (tools/match_libultra.py); these
 * four are the ones DUALHEROES's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), dualheroespc has no game patches — the game's own recompiled
