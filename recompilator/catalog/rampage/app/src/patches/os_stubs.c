 ...
 *
 * SESSION 44: identified in RAMPAGE by signature (tools/match_libultra.py); these
 * four are the ones RAMPAGE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), rampagepc has no game patches — the game's own recompiled
