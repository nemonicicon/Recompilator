 ...
 *
 * SESSION 44: identified in MP1 by signature (tools/match_libultra.py); these
 * four are the ones MP1's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mp1pc has no game patches — the game's own recompiled
