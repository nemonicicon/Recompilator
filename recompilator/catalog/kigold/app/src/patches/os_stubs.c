 ...
 *
 * SESSION 44: identified in KIGOLD by signature (tools/match_libultra.py); these
 * four are the ones KIGOLD's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), kigoldpc has no game patches — the game's own recompiled
