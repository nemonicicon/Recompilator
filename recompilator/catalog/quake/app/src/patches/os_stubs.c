 ...
 *
 * SESSION 44: identified in QUAKE by signature (tools/match_libultra.py); these
 * four are the ones QUAKE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), quakepc has no game patches — the game's own recompiled
