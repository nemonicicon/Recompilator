 ...
 *
 * SESSION 44: identified in GOLDENNUGGET by signature (tools/match_libultra.py); these
 * four are the ones GOLDENNUGGET's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), goldennuggetpc has no game patches — the game's own recompiled
