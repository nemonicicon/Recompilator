 ...
 *
 * SESSION 44: identified in WWFATTITUDE by signature (tools/match_libultra.py); these
 * four are the ones WWFATTITUDE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), wwfattitudepc has no game patches — the game's own recompiled
