 ...
 *
 * SESSION 44: identified in TOYSTORY2BUZZLIGHT by signature (tools/match_libultra.py); these
 * four are the ones TOYSTORY2BUZZLIGHT's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), toystory2buzzlightpc has no game patches — the game's own recompiled
