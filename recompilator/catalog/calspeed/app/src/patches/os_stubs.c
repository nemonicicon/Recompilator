 ...
 *
 * SESSION 44: identified in CALSPEED by signature (tools/match_libultra.py); these
 * four are the ones CALSPEED's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), calspeedpc has no game patches — the game's own recompiled
