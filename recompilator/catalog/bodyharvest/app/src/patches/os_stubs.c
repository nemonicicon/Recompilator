 ...
 *
 * SESSION 44: identified in BODYHARVEST by signature (tools/match_libultra.py); these
 * four are the ones BODYHARVEST's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), bodyharvestpc has no game patches — the game's own recompiled
