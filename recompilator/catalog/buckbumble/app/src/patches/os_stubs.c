 ...
 *
 * SESSION 44: identified in BUCKBUMBLE by signature (tools/match_libultra.py); these
 * four are the ones BUCKBUMBLE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), buckbumblepc has no game patches — the game's own recompiled
