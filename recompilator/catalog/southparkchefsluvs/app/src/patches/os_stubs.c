 ...
 *
 * SESSION 44: identified in SOUTHPARKCHEFSLUVS by signature (tools/match_libultra.py); these
 * four are the ones SOUTHPARKCHEFSLUVS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), southparkchefsluvspc has no game patches — the game's own recompiled
