 ...
 *
 * SESSION 44: identified in FORSAKEN by signature (tools/match_libultra.py); these
 * four are the ones FORSAKEN's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), forsakenpc has no game patches — the game's own recompiled
