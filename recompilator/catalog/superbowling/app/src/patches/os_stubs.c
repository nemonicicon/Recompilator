 ...
 *
 * SESSION 44: identified in SUPERBOWLING by signature (tools/match_libultra.py); these
 * four are the ones SUPERBOWLING's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), superbowlingpc has no game patches — the game's own recompiled
