 ...
 *
 * SESSION 44: identified in SM64 by signature (tools/match_libultra.py); these
 * four are the ones SM64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), sm64pc has no game patches — the game's own recompiled
...
#if 0  /* [RUNG3-LLE-SI] retired: the cartridge's own recompiled SI driver serves this */
RECOMP_FUNC
