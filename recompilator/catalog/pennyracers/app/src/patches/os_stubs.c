 ...
 *
 * SESSION 44: identified in PENNYRACERS by signature (tools/match_libultra.py); these
 * four are the ones PENNYRACERS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), pennyracerspc has no game patches — the game's own recompiled
