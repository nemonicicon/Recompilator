 ...
 *
 * SESSION 44: identified in LEGENDOFZELDATHEOC by signature (tools/match_libultra.py); these
 * four are the ones LEGENDOFZELDATHEOC's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), legendofzeldatheocpc has no game patches — the game's own recompiled
