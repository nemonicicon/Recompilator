...
namespace N64Recomp {
    ...
    struct Config {
        ...
        // Names of functions whose manual size is EXACT (no severed auto-extension, hard boundary for
        // neighbors). Emitted by gen_toml.py from <game>/_force_func_sizes.txt.
        std::vector<std::string> exact_size_funcs;
