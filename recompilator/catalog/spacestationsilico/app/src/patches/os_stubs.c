 ...
 *
 * SESSION 44: identified in SPACESTATIONSILICO by signature (tools/match_libultra.py); these
 * four are the ones SPACESTATIONSILICO's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), spacestationsilicopc has no game patches — the game's own recompiled
