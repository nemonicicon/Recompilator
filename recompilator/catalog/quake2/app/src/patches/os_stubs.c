 ...
 *
 * SESSION 44: identified in QUAKE2 by signature (tools/match_libultra.py); these
 * four are the ones QUAKE2's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), quake2pc has no game patches — the game's own recompiled
