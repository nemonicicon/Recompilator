...
namespace plume {
    ...
    struct RenderDeviceCapabilities {
        ...
        // Blending. dualSrcBlend = SRC1_COLOR/SRC1_ALPHA dual-source output blending. Absent on
        // some limited GPUs (e.g. Raspberry Pi V3D) — consumers must fall back to single-source.
