 ...
 *
 * SESSION 44: identified in MADDENNFL2000 by signature (tools/match_libultra.py); these
 * four are the ones MADDENNFL2000's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), maddennfl2000pc has no game patches — the game's own recompiled
