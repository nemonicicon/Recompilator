 ...
 *
 * SESSION 44: identified in ARMYMENSARGE by signature (tools/match_libultra.py); these
 * four are the ones ARMYMENSARGE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), armymensargepc has no game patches — the game's own recompiled
