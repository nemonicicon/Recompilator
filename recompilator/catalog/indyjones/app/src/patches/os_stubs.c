 ...
 *
 * SESSION 44: identified in INDYJONES by signature (tools/match_libultra.py); these
 * four are the ones INDYJONES's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), indyjonespc has no game patches — the game's own recompiled
