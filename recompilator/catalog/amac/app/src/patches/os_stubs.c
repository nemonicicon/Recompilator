 ...
 *
 * SESSION 44: identified in AMAC by signature (tools/match_libultra.py); these
 * four are the ones AMAC's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), amacpc has no game patches — the game's own recompiled
