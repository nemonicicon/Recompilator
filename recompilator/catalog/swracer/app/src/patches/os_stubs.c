 ...
 *
 * SESSION 44: identified in SWRACER by signature (tools/match_libultra.py); these
 * four are the ones SWRACER's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), swracerpc has no game patches — the game's own recompiled
