 ...
 *
 * SESSION 44: identified in KENGRIFFEYJRSSLUGF by signature (tools/match_libultra.py); these
 * four are the ones KENGRIFFEYJRSSLUGF's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), kengriffeyjrsslugfpc has no game patches — the game's own recompiled
