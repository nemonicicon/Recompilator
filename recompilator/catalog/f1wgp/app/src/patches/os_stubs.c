 ...
 *
 * SESSION 44: identified in F1WGP by signature (tools/match_libultra.py); these
 * four are the ones F1WGP's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), f1wgppc has no game patches — the game's own recompiled
