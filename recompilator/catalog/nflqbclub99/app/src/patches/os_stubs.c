 ...
 *
 * SESSION 44: identified in NFLQBCLUB99 by signature (tools/match_libultra.py); these
 * four are the ones NFLQBCLUB99's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nflqbclub99pc has no game patches — the game's own recompiled
