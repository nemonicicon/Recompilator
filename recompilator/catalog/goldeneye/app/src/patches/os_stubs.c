 ...
 *
 * SESSION 44: identified in GOLDENEYE by signature (tools/match_libultra.py); these
 * four are the ones GOLDENEYE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), goldeneyepc has no game patches — the game's own recompiled
