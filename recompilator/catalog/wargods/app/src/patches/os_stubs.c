 ...
 *
 * SESSION 44: identified in WARGODS by signature (tools/match_libultra.py); these
 * four are the ones WARGODS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), wargodspc has no game patches — the game's own recompiled
