 ...
 *
 * SESSION 44: identified in WWFWARZONE by signature (tools/match_libultra.py); these
 * four are the ones WWFWARZONE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), wwfwarzonepc has no game patches — the game's own recompiled
