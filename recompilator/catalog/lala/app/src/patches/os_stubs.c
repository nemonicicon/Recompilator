 ...
 *
 * SESSION 44: identified in LALA by signature (tools/match_libultra.py); these
 * four are the ones LALA's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), lalapc has no game patches — the game's own recompiled
