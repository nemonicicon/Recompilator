 ...
 *
 * SESSION 44: identified in VCHESS by signature (tools/match_libultra.py); these
 * four are the ones VCHESS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), vchesspc has no game patches — the game's own recompiled
