 ...
 *
 * SESSION 44: identified in NAGANO by signature (tools/match_libultra.py); these
 * four are the ones NAGANO's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), naganopc has no game patches — the game's own recompiled
