 ...
 *
 * SESSION 44: identified in BAM99 by signature (tools/match_libultra.py); these
 * four are the ones BAM99's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), bam99pc has no game patches — the game's own recompiled
