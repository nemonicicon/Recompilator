 ...
 *
 * SESSION 44: identified in MACE by signature (tools/match_libultra.py); these
 * four are the ones MACE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), macepc has no game patches — the game's own recompiled
