 ...
 *
 * SESSION 44: identified in NBALIVE99 by signature (tools/match_libultra.py); these
 * four are the ones NBALIVE99's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), nbalive99pc has no game patches — the game's own recompiled
