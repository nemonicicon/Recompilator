 ...
 *
 * SESSION 44: identified in QUEST64 by signature (tools/match_libultra.py); these
 * four are the ones QUEST64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), quest64pc has no game patches — the game's own recompiled
