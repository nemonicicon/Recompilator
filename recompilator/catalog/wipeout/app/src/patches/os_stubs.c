 ...
 *
 * SESSION 44: identified in WIPEOUT by signature (tools/match_libultra.py); these
 * four are the ones WIPEOUT's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), wipeoutpc has no game patches — the game's own recompiled
