 ...
 *
 * SESSION 44: identified in MADDENNFL99 by signature (tools/match_libultra.py); these
 * four are the ones MADDENNFL99's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), maddennfl99pc has no game patches — the game's own recompiled
