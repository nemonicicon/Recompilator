 ...
 *
 * SESSION 44: identified in LoD by signature (tools/match_libultra.py); these
 * four are the ones LoD's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), lodpc has no game patches — the game's own recompiled
...
/* osPiRawWriteIo: raw PI IO-space word write (cart/flash hardware). No cart hardware on the
 * PC port; success no-op (r2=0) is the standard treatment. Found by the 2026-07-15 sweep
 * (LNK2019 from func_800A4D00). */
