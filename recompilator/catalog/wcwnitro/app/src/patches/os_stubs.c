 ...
 *
 * SESSION 44: identified in WCWNITRO by signature (tools/match_libultra.py); these
 * four are the ones WCWNITRO's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), wcwnitropc has no game patches — the game's own recompiled
