 ...
 *
 * SESSION 44: identified in MADDENFOOTBALL64 by signature (tools/match_libultra.py); these
 * four are the ones MADDENFOOTBALL64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), maddenfootball64pc has no game patches — the game's own recompiled
