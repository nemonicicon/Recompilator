 ...
 *
 * SESSION 44: identified in MORTALKOMBATTRILOG by signature (tools/match_libultra.py); these
 * four are the ones MORTALKOMBATTRILOG's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), mortalkombattrilogpc has no game patches — the game's own recompiled
