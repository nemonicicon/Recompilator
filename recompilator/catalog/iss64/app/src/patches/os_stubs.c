 ...
 *
 * SESSION 44: identified in ISS64 by signature (tools/match_libultra.py); these
 * four are the ones ISS64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), iss64pc has no game patches — the game's own recompiled
