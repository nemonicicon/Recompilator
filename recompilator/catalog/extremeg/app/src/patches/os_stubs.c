 ...
 *
 * SESSION 44: identified in EXTREMEG by signature (tools/match_libultra.py); these
 * four are the ones EXTREMEG's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), extremegpc has no game patches — the game's own recompiled
