 ...
 *
 * SESSION 44: identified in BUGSLIFEA by signature (tools/match_libultra.py); these
 * four are the ones BUGSLIFEA's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), bugslifeapc has no game patches — the game's own recompiled
