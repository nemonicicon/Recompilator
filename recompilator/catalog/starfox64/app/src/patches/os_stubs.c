 ...
 *
 * SESSION 44: identified in STARFOX64 by signature (tools/match_libultra.py); these
 * four are the ones STARFOX64's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), starfox64pc has no game patches — the game's own recompiled
