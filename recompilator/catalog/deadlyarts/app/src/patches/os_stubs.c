 ...
 *
 * SESSION 44: identified in DEADLYARTS by signature (tools/match_libultra.py); these
 * four are the ones DEADLYARTS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), deadlyartspc has no game patches — the game's own recompiled
