 ...
 *
 * SESSION 44: identified in READY2RUMBLEBOXING by signature (tools/match_libultra.py); these
 * four are the ones READY2RUMBLEBOXING's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), ready2rumbleboxingpc has no game patches — the game's own recompiled
