 ...
 *
 * SESSION 44: identified in CV64BLIND by signature (tools/match_libultra.py); these
 * four are the ones CV64BLIND's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), cv64blindpc has no game patches — the game's own recompiled
