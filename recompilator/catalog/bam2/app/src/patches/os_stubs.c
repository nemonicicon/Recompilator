 ...
 *
 * SESSION 44: identified in BAM2 by signature (tools/match_libultra.py); these
 * four are the ones BAM2's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), bam2pc has no game patches — the game's own recompiled
