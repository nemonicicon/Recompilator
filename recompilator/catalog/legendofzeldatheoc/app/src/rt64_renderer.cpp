/**
 * rt64_renderer.cpp — RT64Context implementation for LEGENDOFZELDATHEOCPC.
 *
 * Same wrapper as cv64pc's (the engine-proven shape), minus the CV64-specific
 * DL-dump probes. LEGENDOFZELDATHEOC uses the same F3DEX2 fifo 2.06 microcode as CV64.
 */
                         ...
                         bool developer_mode)
{
    ...
    appConfig.appId = "legendofzeldatheocpc";
