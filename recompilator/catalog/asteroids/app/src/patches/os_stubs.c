 ...
 *
 * SESSION 44: identified in ASTEROIDS by signature (tools/match_libultra.py); these
 * four are the ones ASTEROIDS's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), asteroidspc has no game patches — the game's own recompiled
