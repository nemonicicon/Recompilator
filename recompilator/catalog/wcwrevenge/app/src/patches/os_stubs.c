 ...
 *
 * SESSION 44: identified in WCWREVENGE by signature (tools/match_libultra.py); these
 * four are the ones WCWREVENGE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), wcwrevengepc has no game patches — the game's own recompiled
