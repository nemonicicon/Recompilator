 ...
 *
 * SESSION 44: identified in TETRISPHERE by signature (tools/match_libultra.py); these
 * four are the ones TETRISPHERE's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), tetrispherepc has no game patches — the game's own recompiled
