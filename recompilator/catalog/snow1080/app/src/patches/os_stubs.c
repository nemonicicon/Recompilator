 ...
 *
 * SESSION 44: identified in SNOW1080 by signature (tools/match_libultra.py); these
 * four are the ones SNOW1080's recompiled code actually calls.
 *
 ...
 * mapOverlay HLE), snow1080pc has no game patches — the game's own recompiled
